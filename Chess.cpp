...
{
    initgraph(800,800);
    loadimage(0, "sc/wzqqp.jpg(1).jpg");//显示棋盘
    loadimage(&chessBlackImg, "sc/black.png", chessSize, chessSize, true);
    loadimage(&chessWhiteImg, "sc/white.png", chessSize, chessSize, true);
...
bool Chess::checkOver()
{
    if (checkWin()) {
        ...
        {  //黑棋赢（玩家赢）,此时标记已经反转，轮到白棋落子
            loadimage(0, "sc/胜利.jpg");
        }
        else
        {
            loadimage(0, "sc/失败.jpg");
        }
